...
type CrawlProblemRequest struct {
	...
	RemoteProblemId int32 `protobuf:"varint,2,opt,name=remote_problem_id,json=remoteProblemId,proto3" json:"remote_problem_id,omitempty"`
}
...
func (x *CrawlProblemRequest) GetRemoteProblemId() int32 {
	if x != nil {
...
var file_crawlerpb_service_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x72, 0x65, 0x6d, 0x6f, 0x74,
